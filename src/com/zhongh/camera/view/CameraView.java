package com.zhongh.camera.view;
...
import com.zhongh.camera.view.CameraContainer.TakePictureListener;
...
//		String path=FileOperateUtil.getFolderPath(getContext(), FileOperateUtil.TYPE_VIDEO, "test");
		String path = (String) this.getResources().getText(R.string.VideoRecordDir);
	...
	private Bitmap saveThumbnail() throws FileNotFoundException, IOException {
		if(mRecordPath!=null){
			...
			if(bitmap!=null){
				...
				String mThumbnailFolder = (String) this.getResources().getText(R.string.VideoRecordDir);
