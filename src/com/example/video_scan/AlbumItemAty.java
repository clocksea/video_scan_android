...
import com.zhongh.FileOperateUtil;
import com.zhongh.album.view.AlbumViewPager;
import com.zhongh.album.view.AlbumViewPager.OnPlayVideoListener;
import com.zhongh.album.view.AlbumViewPager.ViewPagerAdapter;
import com.zhongh.album.view.MatrixImageView.OnSingleTapListener;
import com.zhongh.video.view.VideoPlayerContainer;
import com.zhongh.video.view.VideoPlayerView;
...
//		String thumbnailFolder=FileOperateUtil.getFolderPath(this, FileOperateUtil.TYPE_THUMBNAIL, rootPath);
		String folder = (String) this.getResources().getText(R.string.VideoRecordDir);
		String thumbnailFolder = (String) this.getResources().getText(R.string.VideoRecordDir);
		//获取图片文件大图
