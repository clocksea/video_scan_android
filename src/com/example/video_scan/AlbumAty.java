...
import com.zhongh.album.view.AlbumGridView;
import com.zhongh.album.view.AlbumGridView.AlbumViewAdapter;
...
public class AlbumAty extends Activity implements View.OnClickListener,AlbumGridView.OnCheckedChangeListener{
	...
	public void loadAlbum(String rootPath,String format){
		...
		String thumbFolder = (String) this.getResources().getText(R.string.VideoRecordDir);
